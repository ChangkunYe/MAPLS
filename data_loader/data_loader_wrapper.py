...
def data_loader_wrapper(config, imb_test_config=None):
    ...
    # Dataloader for ImageNet datasets, data info loaded in --datapath + '/' + dataset
        ...
        from data_loader.data_loader_ImageNet import load_data
    ...
    return load_data(config['path'], data_transforms, config, imb_test_config)
